...
To learn about what other purposes memos can be used for, see our [Memos section](https://developers.stellar.org/docs/learn/fundamentals/transactions/operations-and-transactions.md#memo).
